...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/Arduino/acceleo/main/generate";
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(arduino.ArduinoPackage.class)) {
            resourceSet.getPackageRegistry().put(arduino.ArduinoPackage.eINSTANCE.getNsURI(), arduino.ArduinoPackage.eINSTANCE);
        }

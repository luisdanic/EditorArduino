 ...
 * </p>
 * <ul>
 *   <li>{@link arduino.impl.DoWhileImpl#getOperando <em>Operando</em>}</li>
 *   <li>{@link arduino.impl.DoWhileImpl#getReferencia <em>Referencia</em>}</li>
 *   <li>{@link arduino.impl.DoWhileImpl#getValor <em>Valor</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DoWhileImpl extends BloquesImpl implements DoWhile {
	/**
	...
	protected EClass eStaticClass() {
		return ArduinoPackage.Literals.DO_WHILE;
	}
	...
	public void setOperando(operandos newOperando) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoPackage.DO_WHILE__OPERANDO, oldOperando,
					operando));
	}
	...
	public void setReferencia(String newReferencia) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoPackage.DO_WHILE__REFERENCIA, oldReferencia,
					referencia));
	}
	...
	public void setValor(String newValor) {
		...
		valor = newValor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoPackage.DO_WHILE__VALOR, oldValor, valor));
	}

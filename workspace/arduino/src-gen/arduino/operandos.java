...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>operandos</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see arduino.ArduinoPackage#getoperandos()
 * @model
 * @generated
 */
public enum operandos implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>operandos</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final operandos[] VALUES_ARRAY = new operandos[] { MENOR, MAYOR, MENORIGUAL, MAYORIGUAL, IGUAL,
			DIFERENTE, };

	/**
	 * A public read-only list of all the '<em><b>operandos</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<operandos> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>operandos</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static operandos get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			operandos result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>operandos</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static operandos getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			operandos result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>operandos</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static operandos get(int value) {
		switch (value) {
		case MENOR_VALUE:
			return MENOR;
		case MAYOR_VALUE:
	 ...
	 * @generated
	 */
	private operandos(int value, String name, String literal) {
		this.value = value;
		this.name = name;

 ...
 * @generated
 */
public class ArduinoActionBarContributor extends EditingDomainActionBarContributor
	...
	protected IAction showPropertiesViewAction = new Action(
			ArduinoEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
		@Override
		public void run() {
			try {
	...
	protected IAction refreshViewerAction = new Action(
			ArduinoEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
		@Override
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(ArduinoEditorPlugin.INSTANCE.getString("_UI_ArduinoEditor_menu"),
				"arduinoMenuID");
		...
		createSiblingMenuManager = new MenuManager(
				ArduinoEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));

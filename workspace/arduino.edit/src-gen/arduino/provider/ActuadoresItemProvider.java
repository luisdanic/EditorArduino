...
/**
 * This is the item provider adapter for a {@link arduino.Actuadores} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActuadoresItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public ActuadoresItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addPinPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Actuadores_pin_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Actuadores_pin_feature",
								"_UI_Actuadores_type"),
						ArduinoPackage.Literals.ACTUADORES__PIN, true, false, false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Actuadores"));
	}
	...
	public String getText(Object object) {
		Actuadores actuadores = (Actuadores) object;
		return getString("_UI_Actuadores_type") + " " + actuadores.getPin();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Actuadores.class)) {

...
/**
 * This is the item provider adapter for a {@link arduino.Variar} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariarItemProvider extends InstruccionesItemProvider {
	/**
	 ...
	 * @generated
	 */
	public VariarItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addPwmPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Variar_pwm_feature"),
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Variar"));
	}
	...
	public String getText(Object object) {
		Variar variar = (Variar) object;
		return getString("_UI_Variar_type") + " " + variar.getPwm();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Variar.class)) {
